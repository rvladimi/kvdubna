...
<table width="1200" border="0" cellspacing="0" cellpadding="10" onmousedown="return false">
    ...
    <tr>
        <td colspan="3" valign="bottom">
            <h2>Cписок гаражей/машиномест:</h2>
        </td>
    </tr>
</table>

<c:forEach var="garage" items="${garageList}">
    <table width="1200" style="background : #FFFDD0;" width="100%" border="0" cellspacing="10" cellpadding="0">
        <tr>
            <td colspan="4">
                    ${garage.forSale ? "Продажа" : "Аренда"},
                     Адрес: <b>${garage.address}</b>,
                     ${garage.hide ? "Объявление снято" : "Объявление активно"}

            </td>
        </tr>
        <tr>
            <form action="admingarage" method="GET">
                <td width="9%">
            ...
            <form action="admingarage" method="GET">
                <td width="13%">
                    <input type="submit" class="select2" style="cursor: pointer;" name="adminAction"
                           value="${garage.hide ? "активировать" : "снять"}">
                    <input type="hidden" name="id" value="${garage.id}">
                </td>
            </form>
            <td></td>
