...
<table width="1250" border="0" cellspacing="0" cellpadding="10" onmousedown="return false">
    <tr>
        ...
        <form action="admin" method="POST">
            ...
            <input type="hidden" name="realtyType" value="таунхаус">
        </form>
    </tr>
</table>

<form action="townhouseSaveChanges" method="post" enctype="multipart/form-data">
    ...
    <table width="1000" border="0" cellspacing="0" cellpadding="15">
        ...
        <tr>
            ...
            <td><input type="text" name="address" value="${townhouse.address}" size="50"></td>
        </tr>

        <tr>
            <td align="left" width="250">Цена</td>
            <td><input type="text" name="price" value="${townhouse.price}" size="50"></td>
        </tr>

        <tr>
            <td align="left" width="250">Общая площадь (м.кв)</td>
            <td><input type="text" name="fullarea" value="${townhouse.fullHomeArea}" size="10"></td>
        </tr>

        <tr>
            <td align="left" width="250">Жилая площадь (м.кв)</td>
            <td><input type="text" name="livingarea" value="${townhouse.livingArea}" size="10"></td>
        </tr>

        <tr>
            <td align="left" width="250">Площадь кухни (м.кв)</td>
            <td><input type="text" name="kitchenarea" value="${townhouse.kitchenArea}" size="10"></td>
        </tr>

        <tr>
            <td align="left" width="250">Площадь комнат (м.кв)</td>
            <td><input type="text" name="roomsarea" value="${townhouse.roomsArea}" size="10"></td>
        </tr>

        <tr>
            <td align="left" valign="center">Описание</td>
            <td><textarea name="description" cols="50" rows="5">${townhouse.description}</textarea>
            </td>
        </tr>

        <c:if test="${not empty townhouse.photo1}">
            <tr bgcolor="#FFFDD0">
                <td align="left" width="100">Фото 1</td>
                <td>
                    <img src="/resources/images/${townhouse.photo1}" width="150">
                    ...
                    <input type="hidden" name="photo1Name" value="${townhouse.photo1}">
                    <input type="hidden" name="changePhoto1" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo1}">
            <tr bgcolor="#FFFDD0">
        ...
        <c:if test="${not empty townhouse.photo2}">
            <tr>
                <td align="left" width="100">Фото 2</td>
                <td>
                    <img src="/resources/images/${townhouse.photo2}" width="150">
                    ...
                    <input type="hidden" name="photo2Name" value="${townhouse.photo2}">
                    <input type="hidden" name="changePhoto2" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo2}">
            <tr>
        ...
        <c:if test="${not empty townhouse.photo3}">
            <tr bgcolor="#FFFDD0">
                <td align="left" width="100">Фото 3</td>
                <td>
                    <img src="/resources/images/${townhouse.photo3}" width="150">
                    ...
                    <input type="hidden" name="photo3Name" value="${townhouse.photo3}">
                    <input type="hidden" name="changePhoto3" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo3}">
            <tr bgcolor="#FFFDD0">
        ...
        <c:if test="${not empty townhouse.photo4}">
            <tr>
                <td align="left" width="100">Фото 4</td>
                <td>
                    <img src="/resources/images/${townhouse.photo4}" width="150">
                    ...
                    <input type="hidden" name="photo4Name" value="${townhouse.photo4}">
                    <input type="hidden" name="changePhoto4" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo4}">
            <tr>
        ...
        <c:if test="${not empty townhouse.photo5}">
            <tr bgcolor="#FFFDD0">
                <td align="left" width="100">Фото 5</td>
                <td>
                    <img src="/resources/images/${townhouse.photo5}" width="150">
                    ...
                    <input type="hidden" name="photo5Name" value="${townhouse.photo5}">
                    <input type="hidden" name="changePhoto5" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo5}">
            <tr bgcolor="#FFFDD0">
        ...
        <c:if test="${not empty townhouse.photo6}">
            <tr>
                <td align="left" width="100">Фото 6</td>
                <td>
                    <img src="/resources/images/${townhouse.photo6}" width="150">
                    ...
                    <input type="hidden" name="photo6Name" value="${townhouse.photo6}">
                    <input type="hidden" name="changePhoto6" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo6}">
            <tr>
        ...
        <c:if test="${not empty townhouse.photo7}">
            <tr bgcolor="#FFFDD0">
                <td align="left" width="100">Фото 7</td>
                <td>
                    <img src="/resources/images/${townhouse.photo7}" width="150">
                    ...
                    <input type="hidden" name="photo7Name" value="${townhouse.photo7}">
                    <input type="hidden" name="changePhoto7" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo7}">
            <tr bgcolor="#FFFDD0">
        ...
        <c:if test="${not empty townhouse.photo8}">
            <tr>
                <td align="left" width="100">Фото 8</td>
                <td>
                    <img src="/resources/images/${townhouse.photo8}" width="150">
                    ...
                    <input type="hidden" name="photo8Name" value="${townhouse.photo8}">
                    <input type="hidden" name="changePhoto8" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo8}">
            <tr>
        ...
        <c:if test="${not empty townhouse.photo9}">
            <tr bgcolor="#FFFDD0">
                <td align="left" width="100">Фото 9</td>
                <td>
                    <img src="/resources/images/${townhouse.photo9}" width="150">
                    ...
                    <input type="hidden" name="photo9Name" value="${townhouse.photo9}">
                    <input type="hidden" name="changePhoto9" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo9}">
            <tr bgcolor="#FFFDD0">
        ...
        <c:if test="${not empty townhouse.photo10}">
            <tr>
                <td align="left" width="100">Фото 10</td>
                <td>
                    <img src="/resources/images/${townhouse.photo10}" width="150">
                    ...
                    <input type="hidden" name="photo10Name" value="${townhouse.photo10}">
                    <input type="hidden" name="changePhoto10" value="yes">
                </td>
            </tr>
        </c:if>

        <c:if test="${empty townhouse.photo10}">
            <tr>
        ...
        <tr>
            <td></td>
            <td>
                <input type="hidden" name="id" value="${townhouse.id}">
