...
<table width="1200" border="0" cellspacing="0" cellpadding="10" onmousedown="return false">
    ...
    <tr>
        <td colspan="3" valign="bottom">
            <h2>Cписок коттеджей:</h2>
        </td>
    </tr>
</table>

<c:forEach var="cottage" items="${cottageList}">
    <table width="1200" style="background : #FFFDD0;" width="100%" border="0" cellspacing="10" cellpadding="0">
        <tr>
            <td colspan="4">
                    ${cottage.forSale ? "Продажа" : "Аренда"},
                     Адрес: <b>${cottage.address}</b>,
                     ${cottage.hide ? "Объявление снято" : "Объявление активно"}

            </td>
        </tr>
        <tr>
            <form action="admincottage" method="GET">
                <td width="9%">
            ...
            <form action="admincottage" method="GET">
                <td width="13%">
                    <input type="submit" class="select2" style="cursor: pointer;" name="adminAction"
                           value="${cottage.hide ? "активировать" : "снять"}">
                    <input type="hidden" name="id" value="${cottage.id}">
                </td>
            </form>
            <td></td>
