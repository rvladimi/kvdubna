...
<h1 align="center">${ad.forSale ? "Продажа" : "Аренда"} коттеджа</h1>
...
<table width="900" cellspacing="10" cellpadding="5">
    ...
    <c:if test="${ad.homeArea ne 0}">
    <tr>
        <td align="left" width="40%"><b>Площадь дома (кв.м)</b></td>
        <td>${ad.homeArea}</td>
    </tr>
    </c:if>
    ...
    <tr>
        <td align="left" width="40%"><b>Площадь участка (сотки)</b></td>
        <td>${ad.landArea}</td>
    </tr>
    </c:if>

    <c:if test="${not empty ad.electricity}">
    <tr>
        <td align="left" width="40%"><b>Электричество</b></td>
        <td>${ad.electricity}</td>
    </tr>
    </c:if>

    <c:if test="${not empty ad.water}">
    <tr>
        <td align="left" width="40%"><b>Вода</b></td>
        <td>${ad.water}</td>
    </tr>
    </c:if>

    <c:if test="${not empty ad.gas}">
    <tr>
        <td align="left" width="40%"><b>Газ</b></td>
        <td>${ad.gas}</td>
    </tr>
    </c:if>

    <c:if test="${not empty ad.sewerage}">
    <tr>
        <td align="left" width="40%"><b>Канализация</b></td>
        <td>${ad.sewerage}</td>
    </tr>
    </c:if>
