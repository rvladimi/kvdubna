...
<table width="1200" border="0" cellspacing="0" cellpadding="10" onmousedown="return false">
    ...
    <tr>
        <td colspan="3" valign="bottom">
            <h2>Cписок таунхаусов:</h2>
        </td>
    </tr>
</table>

<c:forEach var="townhouse" items="${townhouseList}">
    <table width="1200" style="background : #FFFDD0;" width="100%" border="0" cellspacing="10" cellpadding="0">
        <tr>
            <td colspan="4">
                    ${townhouse.forSale ? "Продажа" : "Аренда"},
                     Адрес: <b>${townhouse.address}</b>,
                     ${townhouse.hide ? "Объявление снято" : "Объявление активно"}

            </td>
        </tr>
        <tr>
            <form action="admintownhouse" method="GET">
                <td width="9%">
            ...
            <form action="admintownhouse" method="GET">
                <td width="13%">
                    <input type="submit" class="select2" style="cursor: pointer;" name="adminAction"
                           value="${townhouse.hide ? "активировать" : "снять"}">
                    <input type="hidden" name="id" value="${townhouse.id}">
                </td>
            </form>
            <td></td>
