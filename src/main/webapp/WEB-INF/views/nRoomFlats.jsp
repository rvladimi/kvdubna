...
<table style="background: linear-gradient(to bottom, #DCDCDC, white);" width="1170" height="5%" border="0" class="menu"
    ...
    <tr>
        <td width="113" align="right"><span class="menu">Комнат</span></td>
        <td width="5%" align="right">
            <form action="flat1" method="GET">
                <c:choose>
                    <c:when test="${numberOfRooms eq 1}">
                        <input type="submit" class="menu" style="cursor: pointer; color: white; font-weight: normal; background: #6E6E6E;" value="1">
                    </c:when>
                    <c:otherwise>
                        <input type="submit" class="menu" style="cursor: pointer;" value="1">
                    </c:otherwise>
                </c:choose>
        ...
        <td width="4%" align="right">
            <form action="flat2" method="GET">
                <c:choose>
                    <c:when test="${numberOfRooms eq 2}">
                        <input type="submit" class="menu" style="cursor: pointer; color: white; font-weight: normal; background: #6E6E6E;" value="2">
                    </c:when>
                    <c:otherwise>
                        <input type="submit" class="menu" style="cursor: pointer;" value="2">
                    </c:otherwise>
                </c:choose>
                <input type="hidden" name="forsale" value="true">
            </form>
        ...
        <td width="4%" align="right">
            <form action="flat3" method="GET">
                <c:choose>
                    <c:when test="${numberOfRooms eq 3}">
                        <input type="submit" class="menu" style="cursor: pointer; color: white; font-weight: normal; background: #6E6E6E;" value="3">
                    </c:when>
                    <c:otherwise>
                        <input type="submit" class="menu" style="cursor: pointer;" value="3">
                    </c:otherwise>
                </c:choose>
                <input type="hidden" name="forsale" value="true">
            </form>
        ...
        <td width="6%" align="right">
            <form action="flat4" method="GET">
                <c:choose>
                    <c:when test="${numberOfRooms eq 4}">
                        <input type="submit" class="menu" style="cursor: pointer; color: white; font-weight: normal; background: #6E6E6E;" value="4+">
                    </c:when>
                    <c:otherwise>
                        <input type="submit" class="menu" style="cursor: pointer;" value="4+">
                    </c:otherwise>
                </c:choose>
                <input type="hidden" name="forsale" value="true">
            </form>
        ...
        <td></td>
        <c:choose>
            <c:when test="${pageContext.request.getParameter('forsale')}">
                <td width="13%" align="left">
                    <form action="flat${numberOfRooms}" method="GET">
                ...
                <tr>
                    <td>
                        <form action="allflats" method="GET">
                            <input type="submit" class="menu" style="cursor: pointer; color: white; font-weight: normal; background: #6E6E6E;"
                                   value="Квартиры">
                            <input type="hidden" name="forsale" value="true">
                        </form>
                    </td>
