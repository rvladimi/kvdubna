...
<form action="roomInsert" method="post" enctype="multipart/form-data">
    ...
    <table width="1000" cellspacing="10" cellpadding="4">
        ...
        <tr>
            <td align="left" width="200">Площадь комнаты</td>
            <td><input type="text" name="roomArea" size="3"></td>
        </tr>
        ...
        <tr>
            <td align="left" width="200">Общая площадь квартиры (кв.м)</td>
            <td><input type="text" name="fullArea" size="3"></td>
        </tr>

        <tr>
            <td align="left" width="200">Жилая площадь квартиры</td>
