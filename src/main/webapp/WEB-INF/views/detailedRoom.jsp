...
<h1 align="center">${ad.forSale ? "Продажа" : "Аренда"} комнаты</h1>
...
<table width="900" cellspacing="10" cellpadding="5">
    ...
    <c:if test="${ad.roomArea ne 0}">
    <tr>
        <td align="left" width="40%"><b>Площадь комнаты (кв. м)</b></td>
        <td>${ad.roomArea}</td>
    </tr>
    </c:if>

    <c:if test="${ad.roomsNumber ne 0}">
    <tr>
        <td align="left" width="40%"><b>Число комнат в квартире</b></td>
        <td>${ad.roomsNumber}</td>
    </tr>
    </c:if>

    <c:if test="${ad.fullHomeArea ne 0}">
    <tr>
        <td align="left" width="40%"><b>Общая площадь квартиры (кв.м)</b></td>
    ...
    <tr>
        <td align="left" width="40%"><b>Жилая площадь квартиры</b></td>
        <td>${ad.livingArea}</td>
    </tr>
    </c:if>
    ...
    <c:if test="${ad.floor ne 0}">
    <tr>
        <td align="left" width="40%"><b>Этаж</b></td>
        <td>${ad.floor}</td>
    </tr>
    </c:if>

    <c:if test="${ad.floorsNumber ne 0}">
    <tr>
        <td align="left" width="40%"><b>Количество этажей</b></td>
        <td>${ad.floorsNumber}</td>
    </tr>
    </c:if>

    <c:if test="${not empty ad.balcony}">
    <tr>
        <td align="left" width="40%"><b>Балкон</b></td>
        <td>${ad.balcony}</td>
    </tr>
    </c:if>

    <c:if test="${not empty ad.buildingType}">
    <tr>
        <td align="left" width="40%"><b>Тип дома</b></td>
        <td>${ad.buildingType}</td>
    </tr>
    </c:if>
