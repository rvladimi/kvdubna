...
<form action="commercialInsert" method="post" enctype="multipart/form-data">
    ...
    <table width="1000" cellspacing="10" cellpadding="4">
        ...
        <tr>
            <td align="left" width="250">Площадь (кв.м)</td>
            <td><input type="text" name="area" size="10"></td>
        </tr>

        <tr>
            <td align="left" width="250">Выделенная мощность электроснабжения (кВт)</td>
            <td><input type="text" name="electricPower" size="3"></td>
        </tr>
